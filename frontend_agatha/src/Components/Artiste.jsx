...
const Artiste = ({ artiste }) => {
    ...
    return (
        <div style={{ backgroundImage: `url(${API_URL + artiste.attributes.ImageArtiste.data.attributes.url})`, backgroundColor: `#0000002e`, aspectRatio: `${aspectRatioImg}`, backgroundRepeat: 'no-repeat', backgroundSize: '100%', position: "relative", minHeight: "300px", maxWidth: "90vw" }}>
            {
                displayDescription ?
