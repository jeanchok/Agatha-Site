    ...
    return (
        <div className="wrapper">
            ...
            <div className='socialIcone__Container'>
                <a href="https://instagram.com/" target="_instagram" aria-label="Suivez-nous sur instagram">
                    <FontAwesomeIcon icon={faInstagram} size="3x" className='socialIcone__Container--icone' />
                </a>
                <a href="https://facebook.com/" target="_facebook" aria-label="Suivez-nous sur facebook">
